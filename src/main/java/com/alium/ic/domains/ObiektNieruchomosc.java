...
/**
 * The persistent class for the obiekt_nieruchomosc database table.
 * 
 */
@Entity 
@Table(name="obiekt_nieruchomosc")
public class ObiektNieruchomosc implements Serializable {
